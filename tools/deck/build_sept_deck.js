...
async function main() {
  ...
  /* ── 12 · WHAT IS OPEN ──────────────────────────────────────────────── */
  {
    ...
    const items = [
      ...
      ["3", "Tall street furniture is not in the obstacle map",
       "A canopy or lamp standard reaches cruise height, and a 9 m flight struck one at (48.3, -0.9). A data gap, not a Shield defect"],
